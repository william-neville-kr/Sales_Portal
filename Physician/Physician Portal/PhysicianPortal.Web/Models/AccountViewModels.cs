...
namespace PhysicianPortal.Web.Models
{
    ...
    public class SelectOfficeViewModel
    {
        public int SelectedOffice { get; set; }
        public ICollection<System.Web.Mvc.SelectListItem> Offices { get; set; }
        public string ReturnUrl { get; set; }
        public bool RememberMe { get; set; }
    }
    ...
    public class RegisterViewModel
    {
        ...
        [DataType(DataType.EmailAddress, ErrorMessage = "Entered email is not of correct format")]
        [Display(Name = "Email")]
        [Required]
        public string Email { get; set; }
