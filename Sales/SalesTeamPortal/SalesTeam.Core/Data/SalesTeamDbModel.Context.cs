...
namespace SalesTeam.Core.Data
{
    ...
    public partial class MH_DWEntities : DbContext
    {
        ...
        public virtual DbSet<vwPhysicianAddress> vwPhysicianAddresses { get; set; }
        public virtual DbSet<vwSalesTeam> vwSalesTeams { get; set; }
        public virtual DbSet<vwSalesTeamInfo> vwSalesTeamInfoes { get; set; }
        public virtual DbSet<vwSalesTeamNote> vwSalesTeamNotes { get; set; }
        public virtual DbSet<vwSalesTeamQueue> vwSalesTeamQueues { get; set; }
        public virtual DbSet<SalesTeamNote> SalesTeamNotes { get; set; }
        public virtual DbSet<SalesTeamQueue> SalesTeamQueues { get; set; }
        ...
        public virtual DbSet<vwSalesTeamPhysician> vwSalesTeamPhysicians { get; set; }
        public virtual DbSet<vwDocument> vwDocuments { get; set; }
        public virtual DbSet<AssociatesSalesTeam> AssociatesSalesTeams { get; set; }
        public virtual DbSet<vwPrescription> vwPrescriptions { get; set; }
        public virtual DbSet<vwSalesTeamPatient> vwSalesTeamPatients { get; set; }
        public virtual DbSet<DimProcessTime> DimProcessTimes { get; set; }
        ...
        public virtual DbSet<vwSalesTeamPhysicianDrugTherapySearch> vwSalesTeamPhysicianDrugTherapySearches { get; set; }
        public virtual DbSet<PhysicianConsent> PhysicianConsents { get; set; }
        public virtual DbSet<SalesPortalFaxLog> SalesPortalFaxLogs { get; set; }
        ...
        public virtual ObjectResult<spGetPhysicianNameAndPatientcountForChart_Result> spGetPhysicianNameAndPatientcountForChart(Nullable<System.DateTime> referralDateFrom, Nullable<System.DateTime> referralDateTo, Nullable<int> masterSalesTeamId)
        {
            var referralDateFromParameter = referralDateFrom.HasValue ?
                new ObjectParameter("ReferralDateFrom", referralDateFrom) :
                new ObjectParameter("ReferralDateFrom", typeof(System.DateTime));
    
            var referralDateToParameter = referralDateTo.HasValue ?
                new ObjectParameter("ReferralDateTo", referralDateTo) :
                new ObjectParameter("ReferralDateTo", typeof(System.DateTime));
    
            var masterSalesTeamIdParameter = masterSalesTeamId.HasValue ?
                new ObjectParameter("MasterSalesTeamId", masterSalesTeamId) :
                new ObjectParameter("MasterSalesTeamId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetPhysicianNameAndPatientcountForChart_Result>("spGetPhysicianNameAndPatientcountForChart", referralDateFromParameter, referralDateToParameter, masterSalesTeamIdParameter);
        }
    
        public virtual ObjectResult<spGetDrugShortNameAndPatientcountForChart_Result> spGetDrugShortNameAndPatientcountForChart(Nullable<System.DateTime> referralDateFrom, Nullable<System.DateTime> referralDateTo, Nullable<int> masterSalesTeamId)
        {
            var referralDateFromParameter = referralDateFrom.HasValue ?
                new ObjectParameter("ReferralDateFrom", referralDateFrom) :
                new ObjectParameter("ReferralDateFrom", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetDrugShortNameAndPatientcountForChart_Result>("spGetDrugShortNameAndPatientcountForChart", referralDateFromParameter, referralDateToParameter, masterSalesTeamIdParameter);
        }
    
        public virtual ObjectResult<spDrillDownDrugShortNameAndPatientcountForChart_Result> spDrillDownDrugShortNameAndPatientcountForChart(Nullable<System.DateTime> referralDateFrom, Nullable<System.DateTime> referralDateTo, Nullable<int> masterSalesTeamId)
        {
            var referralDateFromParameter = referralDateFrom.HasValue ?
                new ObjectParameter("ReferralDateFrom", referralDateFrom) :
                new ObjectParameter("ReferralDateFrom", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spDrillDownDrugShortNameAndPatientcountForChart_Result>("spDrillDownDrugShortNameAndPatientcountForChart", referralDateFromParameter, referralDateToParameter, masterSalesTeamIdParameter);
        }
    
        public virtual ObjectResult<spPatientActivityStatusForChart_Result> spPatientActivityStatusForChart(Nullable<System.DateTime> referralDateFrom, Nullable<System.DateTime> referralDateTo, Nullable<int> salesTeamId, Nullable<int> physicianId)
        {
            var referralDateFromParameter = referralDateFrom.HasValue ?
                new ObjectParameter("ReferralDateFrom", referralDateFrom) :
                new ObjectParameter("ReferralDateFrom", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spPatientActivityStatusForChart_Result>("spPatientActivityStatusForChart", referralDateFromParameter, referralDateToParameter, salesTeamIdParameter, physicianIdParameter);
        }
    
        public virtual ObjectResult<spHIPAAConsent_Result> spHIPAAConsent(string patientERPCode)
        {
            var patientERPCodeParameter = patientERPCode != null ?
                new ObjectParameter("PatientERPCode", patientERPCode) :
                new ObjectParameter("PatientERPCode", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spHIPAAConsent_Result>("spHIPAAConsent", patientERPCodeParameter);
        }
    }
}
